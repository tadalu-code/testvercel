...
export default function EditProductPage() {
        ...
        .then(res => {
          if (res.data) {
            ...
            setForm({
              ...
              technicalSpecs: p.specifications || "",
              imagesUrl: Array.isArray(p.imagesUrl) ? p.imagesUrl.join("\n") : (p.imagesUrl || ""),
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!res.ok) {
      ...
      setError(d.error || "Lỗi cập nhật sản phẩm");
      setLoading(false);
      return;
    }
    ...
    <div className="max-w-6xl space-y-5">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Chỉnh sửa thông tin</p>
        </div>
      </div>
