...
export default function RegisterPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      {/* Main Body with Green Background */}
        ...
        <div className="max-w-[1040px] mx-auto w-full px-4 flex items-center justify-between py-12 lg:py-16">
          ...
          <div className="w-full lg:w-[400px] shrink-0 bg-white rounded-[4px] shadow-lg p-[30px] mx-auto lg:mx-0">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-[20px] text-[#222] font-medium">Đăng ký</h2>
            </div>
            ...
            {success && (
              <div className="mb-4 p-3 bg-green-50 border border-green-200 rounded-sm text-green-600 text-[14px] flex items-center gap-2">
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              <div className="text-[12px] text-gray-500 mt-4 text-center px-4">
                Bằng việc đăng ký, bạn đồng ý với{" "}
                <Link href="#" className="text-[#028046] hover:underline">Điều khoản dịch vụ</Link>
                {" "}&{" "}
                <Link href="#" className="text-[#028046] hover:underline">Chính sách bảo mật</Link>
              </div>
            </form>
            ...
            <div className="text-center text-[14px] text-gray-500">
              Bạn đã có tài khoản?{" "}
              <Link href="/auth/login" className="text-[#028046] font-medium hover:underline">
                Đăng nhập
              </Link>
            </div>
